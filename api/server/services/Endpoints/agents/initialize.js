...
const initializeClient = async ({ req, res, endpointOption }) => {
  ...
  console.log(
    `[Endpoints/agents/initialize.js initializeClient] endpointOption: ${inspect(endpointOption, { depth: 5, colors: false })}`,
  );
  ...
  console.log(
    `[Endpoints/agents/initialize.js initializeClient] primaryConfig: ${inspect(primaryConfig, { depth: 5, colors: false })}`,
  );
