...
class BaseClient {
  ...
  async setMessageOptions(opts = {}) {
    ...
    console.log(
      `[BaseClient/setMessageOptions] this.options.agent: ${JSON.stringify(this.options.agent)}`,
    );
    this.currentMessages = (await this.loadHistory(conversationId, head, opts)) ?? [];
    console.log(
      `[BaseClient/setMessageOptions] this.currentMessages: ${JSON.stringify(this.currentMessages)}`,
    );
  ...
  async sendMessage(message, opts = {}) {
    ...
    console.log(`[BaseClient] opts: ${JSON.stringify(opts)}`);
    console.log(`[BaseClient] this.currentMessages: ${JSON.stringify(this.currentMessages)}`);
    ...
    console.log(`[BaseClient] payload: ${JSON.stringify(payload)}`);
  ...
  async loadHistory(conversationId, parentMessageId = null, opts = {}) {
    ...
    console.log(`[BaseClient/loadHistory] messages: ${JSON.stringify(messages)}`);
